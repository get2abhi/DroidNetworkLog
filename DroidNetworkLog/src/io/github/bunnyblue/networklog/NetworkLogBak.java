...
//
//public class NetworkLogBak extends FragmentActivity {
...
//
//  public static ToggleButton floatingActionButton;
...
//
//  public static NetworkLogBak instance;
//
...
//
//      state = NetworkLogBak.State.LOAD_APPS;
...
//      }
//
//      state = NetworkLogBak.State.RUNNING;
//      MyLog.d("Init done");
//    }
//  }
//
...
//
//        if(state != NetworkLogBak.State.RUNNING) {
//          initRunner = new InitRunner(this);
//          new Thread(initRunner, "Initialization " + initRunner).start();
//        }
//
...
//      if(data == null) {
//        // exiting
//        state = NetworkLogBak.State.EXITING;
...
//          sortBy = NetworkLogBak.settings.getSortBy();
//        } else {
...
//            break;
//          default:
//            NetworkLogBak.settings.setSortBy(Sort.BYTES);
//            if(appFragment != null) {
...
//      }
//
//      floatingActionButton = (ToggleButton) findViewById(R.id.actionbar_service_toggle);
...
//    floatingActionButton = (ToggleButton)view;
//
//    if(!isServiceRunning(this, NetworkLogService.class.getName())) {
//      startService();
//      floatingActionButton.setChecked(true);
...
//          NetworkLogBak.settings.setSortBy(Sort.UID);
//          item.setChecked(true);
//          break;
//        case R.id.sort_by_name:
//          NetworkLogBak.settings.setSortBy(Sort.NAME);
//          item.setChecked(true);
//          break;
//        case R.id.sort_by_throughput:
//          NetworkLogBak.settings.setSortBy(Sort.THROUGHPUT);
//          item.setChecked(true);
//          break;
//        case R.id.sort_by_packets:
//          NetworkLogBak.settings.setSortBy(Sort.PACKETS);
//          item.setChecked(true);
//          break;
...
//          NetworkLogBak.settings.setSortBy(Sort.TIMESTAMP);
//          item.setChecked(true);
//          break;
//        default:
